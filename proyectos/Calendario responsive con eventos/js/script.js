...
/*función para agregar días en días con día de clase y fecha anterior 
fecha siguiente en los días del mes anterior y del mes siguiente y activo en hoy*/
...
//Función para agregar activa el día
function addListner() {
  ...
  days.forEach((day) => {
    day.addEventListener("click", (e) => {
      ...
      if (e.target.classList.contains("prev-date")) {
        prevMonth();
        //agregar activo al que se hace clic día tras mes es cambiar
        setTimeout(() => {
          //Agregar activa donde no hay fecha anterior o próxima
          const days = document.querySelectorAll(".day");
          days.forEach((day) => {
            if (
        ...
        nextMonth();
        //agregar activo al día en el que se hace clic después del mes cambia
        setTimeout(() => {
          const days = document.querySelectorAll(".day");
          days.forEach((day) => {
            if (
